...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("на входе " + numOfCucumbers + " огурцов, обьемом " + singletonService.cucumbersToJarsImperativeStyle.standardCucumberVolume + " приступаем к созданию банок ");
