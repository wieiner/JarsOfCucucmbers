...
class CucumbersToJarsImperativeStyleTest {
    ...
    void toJarCheckVolumesOfCucumbersInJars() {
        ...
        Assertions.assertArrayEquals(jars.get(0).getCucumberList().stream()
                .mapToDouble(Cucumber::getVolume).toArray(),new double[] {15.0, 3.0, 3.0});
    }
    ...
    void toJarCheckTotalVolumeInJarsWithDifferentVolumesOfJarsAndCucumbers() {
        ...
        double totalVolumeInFourthJar = jars.get(3).getCucumberList().stream().mapToDouble(Cucumber::getVolume).sum();
        ...
        double totalVolumeInFiveJar = jars.get(4).getCucumberList().stream().mapToDouble(Cucumber::getVolume).sum();
        ...
        double totalVolumeInSixJar = jars.get(5).getCucumberList().stream().mapToDouble(Cucumber::getVolume).sum();
